...
class MainActivity : AppCompatActivity(),AdapterView.OnItemClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        itemsListAdapter = ItemsListAdapter(applicationContext, arrayList!!)
    ...
    private fun setDataToArrayList(): ArrayList<ListItem>{
        ...
        arrayList.add(ListItem(R.drawable.ic_numbers, "Random numbers"))
        arrayList.add(ListItem(R.drawable.ic_word, "Random words"))
        arrayList.add(ListItem(R.drawable.ic_speaker, "Random sounds"))
        arrayList.add(ListItem(R.drawable.ic_password, "Random password"))
        arrayList.add(ListItem(R.drawable.temp, "Lotto"))
        arrayList.add(ListItem(R.drawable.temp, "Coin toss"))
        arrayList.add(ListItem(R.drawable.temp, "Dices"))
        return arrayList
    }
